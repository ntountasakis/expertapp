          ...
          routes: <GoRoute>[
            ...
            GoRoute(
              ...
              path: Routes.EXPERT_CALL_VIDEO_PAGE +
                  ...
                  '/:' +
                  Routes.AGORA_TOKEN_PARM +
                  '/:' +
                  Routes.AGORA_UID,
              builder: (BuildContext context, GoRouterState state) {
                final agoraChannelName =
                    state.params[Routes.AGORA_CHANNEL_NAME_PARM];
                final agoraToken = state.params[Routes.AGORA_TOKEN_PARM];
                final agoraUid = state.params[Routes.AGORA_UID];
