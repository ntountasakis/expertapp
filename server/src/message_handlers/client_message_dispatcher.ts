...
export function dispatchClientMessage({clientMessage, invalidMessageHandler, clientMessageSender, callManager}:
    {clientMessage: ClientMessageContainer, invalidMessageHandler: InvalidClientMessageHandlerInterface,
        clientMessageSender: ClientMessageSenderInterface, callManager: CallManager}): void {
  {
  ...
  if (clientMessage.callInitiateRequest) {
    ...
    handleClientCallInitiateRequest(callInitiateRequest, clientMessageSender, callManager);
    return;
  }
