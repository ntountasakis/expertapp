...
export async function dispatchClientMessage(
  ...
  if (clientMessage.callInitiateRequest) {
    ...
    return await dispatchCallDisconnectRequest(clientMessage.callDisconnectRequest, invalidMessageHandler, callManager);
  }
...
async function dispatchCallDisconnectRequest(callDisconnectRequest: ClientCallDisconnectRequest,
    invalidMessageHandler : InvalidClientMessageHandlerInterface, callManager: CallManager): Promise<boolean> {
  ...
  return await handleClientCallDisconnectRequest(callManager, callDisconnectRequest.uid!);
}
