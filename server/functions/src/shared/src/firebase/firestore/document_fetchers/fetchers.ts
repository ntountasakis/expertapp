...
async function getPaymentStatusDocumentTransaction({paymentStatusId, transaction}:
  { paymentStatusId: string, transaction: FirebaseFirestore.Transaction }): Promise<PaymentStatus> {
